...
public:
	...
	*/
	...
	void socketserver(std::string userInput)
	{
	...
	std::string socketclient(std::string userInput)
	{
		std::string ipAddress = "127.0.0.1";			// IP Address of the server
		int port = 54000;						// Listening port # on the server
